...
class sitesupervisor extends StatefulWidget {
  const sitesupervisor({super.key});

  @override
  State<sitesupervisor> createState() => _sitesupervisorState();
}

class _sitesupervisorState extends State<sitesupervisor> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        body: FutureBuilder(
      future: instance.empoleesdetail('sitesupervisor'),
      builder: (context, snapshot) {
        // if (instance.usermodel.isEmpty) {
        //   return Center(
        //     child: Textwidget(
        //       text: 'No site super add ',
        //       style: TextStyle(),
        //     ),
        //   );
        // }
