...
import 'package:expancetracker/screens/emloyee/screens/feedback.dart';
import 'package:expancetracker/screens/hr/screens/accoundinformation.dart';
import 'package:expancetracker/screens/hr/screens/feedback.dart';
...
class profilepageHr extends StatelessWidget {
  profilepageHr({super.key});
        ...
        onTap: () {
          switch (curentindex) {
            case 1:
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => HrAccoundInformation()),
              );
              break;
            case 2:
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => HrFeedbackScreen()),
              );
            case 3:
